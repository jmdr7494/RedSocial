...
formatter.scenario({
  "comments": [
    {
      "line": 9,
      "value": "#nuevo test incluido en la fase de mantenimiento"
    }
  ],
  "line": 11,
  "name": "Eliminacion incorrecta de la cuenta de un usuario",
  "description": "",
  "id": "eliminar-cuenta-bd;eliminacion-incorrecta-de-la-cuenta-de-un-usuario",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.match({
  "location": "borrarCuentaTest.Datos_incorrectos()"
});
formatter.result({
  "duration": 77576,
  "status": "passed"
...
formatter.scenario({
  ...
  "description": "",
  "id": "publicacion;publicacion-fallida",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.match({
  "location": "publicarTest.Publicacion_incorrecta()"
});
formatter.result({
  "duration": 252826,
  "status": "passed"
...
formatter.scenario({
  ...
  "description": "",
  "id": "edicion-de-una-publicacion-en-la-bd;edicion-incorrecta-de-publicacion",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.match({
  "location": "editarPublicacionBDTest.Edicion_incorrecto()"
});
formatter.result({
  "duration": 73043454,
  "status": "passed"
...
formatter.scenario({
  ...
  "description": "",
  "id": "eliminar-publicacion-db;eliminacion-incorrecta-de-publicacion",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.match({
  "location": "eliminarPublicacionBDTest.Eliminacion_incorrecta()"
});
formatter.result({
  "duration": 162938100,
  "status": "passed"
